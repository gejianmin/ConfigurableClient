...
#import "HomeCell.h"
@interface SecondViewController ()<HHBannerViewDelegate>
{
    int _pageSize;
...
-(void)configDataSource{
    ...
    [[[HHClient sharedInstance] sessionManager] post:kNews_Business params:nil complete:^(id response, HHError *error) {
        [self hideHUD];
