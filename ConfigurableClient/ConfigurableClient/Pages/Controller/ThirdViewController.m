...
#import "HomeCell.h"
@interface ThirdViewController ()<HHBannerViewDelegate>
{
    int _pageSize;
...
-(void)configDataSource{
    ...
    [[[HHClient sharedInstance] sessionManager] post:kNews_World params:nil complete:^(id response, HHError *error) {
        [self hideHUD];
